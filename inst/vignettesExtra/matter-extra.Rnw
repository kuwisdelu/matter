...
<<microbe-ion>>=
image3D(microbe, ~ x * z * y, mz=262, theta=-55, contrast="supp", layout=c(3,1))
@

Now we perform principal components analysis. (Still need to add this part.)
