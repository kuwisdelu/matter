...
%    #    209.000       209.600       983.100       773.500        39.766 
%    #  204.100       204.800      1050.900       846.100        42.655
%    # 204.100       204.800      1050.900       846.100        42.055 
%     # 204.100       204.800      1050.900       846.100        42.019 
%         # 204.100       204.800      1050.900       846.100        42.352 
...
% })
%    # start (MB)   finish (MB) max used (MB) overhead (MB)    time (sec) 
%    #   1409.600      5663.400      7103.600      1440.200        32.574
%    # 1409.40       5663.20       7103.50       1440.30         33.57 
%         # 1409.400      5663.200      7103.500      1440.300        33.349
%      # 1409.400      5663.200      7103.500      1440.300        34.583 
%       # 1409.400      5663.200      7103.500      1440.300        34.125

% matter:::profile({
%   biglm.out <- bigglm(fm, data=data.df, chunksize=10000)
% })
%    # start (MB)   finish (MB) max used (MB) overhead (MB)    time (sec) 
%    #   5663.400      5663.400      8992.600      3329.200       171.613 
%    # 5663.200      5663.300      8992.400      3329.100       174.812 
%    # 5663.200      5663.300      8992.400      3329.100       170.309
%      # 5663.200      5663.300      8992.400      3329.100       179.001
%       # 5663.200      5663.300      8992.400      3329.100       170.043 

% matter:::profile({
%   biglm.bm.out <- biglm.big.matrix(fm, data=data.bm, chunksize=10000)
% })
%    # start (MB)   finish (MB) max used (MB) overhead (MB)    time (sec) 
%    #    5663.40       5663.50       9163.30       3499.80         23.52 
%    # 5663.300      5663.400      9163.100      3499.700        24.488 
%    # 5663.300      5663.400      9163.100      3499.700        23.727
%     # 5663.300      5663.400      9163.100      3499.700        26.083
%      # 5663.300      5663.400      9163.100      3499.700        23.452 
% @
...
% })
%    # start (MB)   finish (MB) max used (MB) overhead (MB)    time (sec) 
%    #   1288.700      1300.900      3550.600      2249.700        10.188 
%     # 1300.700      1300.900      3544.600      2243.700        10.779 
%      # 1300.70       1300.90       3544.60       2243.70         10.34 
%         # 1300.700      1300.900      3544.600      2243.700        10.171 
%          # 1300.900      1301.100      3544.800      2243.700        10.543 
% @
