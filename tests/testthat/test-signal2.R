...
test_that("filter 2d", {
	...
	expect_equal(z1[,,1], filt2_ma(x, width=5))
	expect_equal(z2[,,1], filt2_gauss(x, width=5))
	expect_equal(z3[,,1], filt2_bi(x, width=5))
	expect_equal(z4[,,1], filt2_adapt(x, width=5))
	expect_equal(z5[,,1], filt2_diff(x, niter=5))
	expect_equal(z6[,,1], filt2_guide(x, width=5))
	expect_equal(z7[,,1], filt2_guide(x, width=5))

	expect_equal(z1[,,2], filt2_ma(x, width=5))
	expect_equal(z2[,,2], filt2_gauss(x, width=5))
	expect_equal(z3[,,2], filt2_bi(x, width=5))
	expect_equal(z4[,,2], filt2_adapt(x, width=5))
	expect_equal(z5[,,2], filt2_diff(x, niter=5))
	expect_equal(z6[,,2], filt2_guide(x, width=5))
	expect_equal(z7[,,2], filt2_guide(x, width=5))

	expect_equal(z1[,,3], filt2_ma(x, width=5))
	expect_equal(z2[,,3], filt2_gauss(x, width=5))
	expect_equal(z3[,,3], filt2_bi(x, width=5))
	expect_equal(z4[,,3], filt2_adapt(x, width=5))
	expect_equal(z5[,,3], filt2_diff(x, niter=5))
	expect_equal(z6[,,3], filt2_guide(x, width=5))
	expect_equal(z7[,,3], filt2_guide(x, width=5))
